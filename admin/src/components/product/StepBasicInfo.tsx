...
export function StepBasicInfo({
  ...
  return (
    <section className="space-y-3">
      ...
      <HelpText>
        Nombre y detalle son obligatorios. El detalle describe la prenda al
        cliente.
      </HelpText>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-1">
          ...
          <Input
            ...
            placeholder="ej: Baggy Dad Jeans"
          />
        </div>
        <div className="space-y-1">
      ...
      <div className="space-y-1">
        ...
        <Textarea
          ...
          placeholder="Una descripción corta del producto…"
        />
      </div>
      <div className="space-y-1">
        ...
        <Textarea
          ...
          placeholder="Descripción detallada que verá el cliente. Incluye características, materiales destacados, ocasiones de uso…"
        />
      </div>
    </section>
  );
