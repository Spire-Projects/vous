...
interface StepPricingVisibilityProps {
  ...
  onWholesaleOnlyChange: (v: boolean) => void;
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="space-y-1">
          ...
          <Input
            ...
            onChange={(e) => onWholesalePriceChange(Number(e.target.value))}
      ...
      <div className="space-y-1">
        <Label>
          {hasVariants
            ? "Stock general (solo si no usas variantes)"
            : "Stock total *"}
        </Label>
        <Input
          type="number"
        ...
        {hasVariants && (
          <p className="text-[10px] text-vous-text-secondary">
            El stock se gestiona por variante en el paso anterior.
          </p>
        )}
      </div>
      ...
      <div className="flex items-center gap-3 pt-1">
        ...
        {isDiscounted && (
          <Input
            ...
            onChange={(e) => onDiscountPctChange(Number(e.target.value))}
            className="w-28"
            placeholder="%"
          />
        )}
      ...
      <div className="flex items-center gap-3 pt-1">
        <div className="flex items-center gap-2">
          <Checkbox
            ...
            onCheckedChange={(v) => onWholesaleOnlyChange(v === true)}
          />
      ...
      <HelpText>
        Controla dónde y cómo aparece este producto en la tienda.
      </HelpText>
      ...
      <div className="space-y-1 pt-1">
        ...
        />
        <p className="text-[10px] text-vous-text-secondary">
          Ayudan a los clientes a encontrar productos por estilo u ocasión.
        </p>
      </div>
    </section>
  );
