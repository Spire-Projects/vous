    ...
    <>
      <div className="flex items-center justify-between mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 flex-1">
          ...
          <StatCard
            label="Borradores"
            value={String(posts.length - published)}
          />
                  ...
                  <div key={post.id} className="p-4">
                    <div className="flex gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="font-nav text-[13px] font-semibold text-vous-text line-clamp-2">
                          {post.title}
                        </p>
                        ...
                        {post.excerpt && (
                          <p className="text-[11px] text-vous-text-secondary font-sans line-clamp-1 mt-0.5 italic">
                            {post.excerpt}
                          </p>
                        )}
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-3">
                      ...
                      <div>
                        ...
                        <Badge
                          variant={
                            post.status === "published" ? "active" : "inactive"
                          }
                          className="font-nav text-[10px] uppercase tracking-wide mt-0.5"
                        >
                  ...
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((post) => (
                      <TableRow key={post.id}>
                        ...
                        <TableCell>
                          <p className="font-nav text-[13px] font-semibold text-vous-text line-clamp-1">
                            {post.title}
                          </p>
                          <p className="text-[11px] text-vous-text-secondary font-sans">
                            {post.slug}
      ...
      >
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          {preview && (
            <>
              <DialogHeader>
                <DialogTitle className="font-nav text-[15px] tracking-widest uppercase leading-snug text-vous-text">
                  {preview.title}
                </DialogTitle>
                <p className="text-[11px] text-vous-text-secondary font-sans">
                  {preview.slug}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[12px] font-sans">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <Badge
                      variant={
                        preview.status === "published" ? "active" : "inactive"
                      }
                ...
                {preview.excerpt && (
                  <div className="col-span-2">
                    ...
                    <p className="text-vous-text-secondary leading-relaxed italic">
                      {preview.excerpt}
                    </p>
                  </div>
                )}
                <div className="col-span-2">
                  <p className="font-nav text-[10px] uppercase tracking-wider text-vous-text-secondary mb-2">
                    Contenido (preview)
                  </p>
                  <div
                ...
                {(preview.seoTitle || preview.seoDescription) && (
                  <div className="col-span-2 border border-vous-border p-3 bg-vous-surface space-y-1">
                    ...
                    {preview.seoTitle && (
                      <p className="text-[12px] font-semibold text-vous-text">
                        {preview.seoTitle}
                      </p>
                    )}
