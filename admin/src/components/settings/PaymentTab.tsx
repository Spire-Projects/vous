...
export function PaymentTab({
  ...
  paymentConfig: ReturnType<typeof usePaymentConfig>;
}) {
  return (
    <div className="space-y-6">
      ...
      <p className="font-sans text-sm text-vous-text-secondary">
        Configura el QR y los datos bancarios que los clientes verán al realizar
        un pedido.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-1">
          ...
          <Input
            ...
            onChange={(e) =>
              paymentConfig.update({ accountHolder: e.target.value })
            }
        ...
        <div className="space-y-1">
          ...
          <Input
            ...
            onChange={(e) =>
              paymentConfig.update({ accountNumber: e.target.value })
            }
      ...
      <div className="space-y-1">
        ...
        <Textarea
          ...
          onChange={(e) =>
            paymentConfig.update({ instructions: e.target.value })
          }
      ...
      {paymentConfig.saving && (
        <div className="flex items-center gap-2 text-vous-text-secondary font-sans text-xs">
          <Loader2 size={12} className="animate-spin" /> Guardando configuración
          de pagos…
        </div>
      )}
    </div>
