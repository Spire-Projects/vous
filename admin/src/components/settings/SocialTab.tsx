...
interface SocialTabProps {
  ...
  setInstagramActive: (v: boolean) => void;
  tiktokUrl: string;
  setTiktokUrl: (v: string) => void;
  tiktokActive: boolean;
  setTiktokActive: (v: boolean) => void;
  ubicacionUrl: string;
  setUbicacionUrl: (v: string) => void;
  ubicacionActive: boolean;
  setUbicacionActive: (v: boolean) => void;
}
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <SocialRow
          ...
          setUrl={setTiktokUrl}
          active={tiktokActive}
          setActive={setTiktokActive}
        />
        <SocialRow
          label="Ubicación (Google Maps)"
          url={ubicacionUrl}
          setUrl={setUbicacionUrl}
          active={ubicacionActive}
          setActive={setUbicacionActive}
        />
      </div>
    </div>
  );
