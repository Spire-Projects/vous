...
const _CheckboxItem =
  DropdownMenuPrimitive.CheckboxItem as unknown as CheckboxItemRef;
...
const _Indicator =
  DropdownMenuPrimitive.ItemIndicator as unknown as IndicatorRef;
...
const ITEM_BASE =
  "relative flex cursor-default select-none items-center rounded-xl text-sm outline-none data-[disabled]:opacity-50";
...
>(({ className, inset, children, ...props }, ref) => (
  <_SubTrigger
    ref={ref}
    className={cn(
      "flex px-3 py-2 font-sans text-vous-text focus:bg-amber-50 data-[state=open]:bg-amber-50",
      ITEM_BASE,
      inset && "pl-8",
      className,
    )}
...
>(({ className, ...props }, ref) => (
  <_SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] bg-white border border-white/60 rounded-2xl shadow-xl p-1",
      className,
    )}
    {...props}
  />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <_Content
      ...
      className={cn(
        "z-50 min-w-[160px] bg-white border border-white/60 rounded-2xl shadow-xl shadow-black/5 py-1",
        className,
      )}
      {...props}
    />
...
>(({ className, inset, ...props }, ref) => (
  <_Item
    ref={ref}
    className={cn(
      "gap-2 px-3 py-2 font-sans text-vous-text focus:bg-amber-50",
      ITEM_BASE,
      inset && "pl-8",
      className,
    )}
...
>(({ className, children, checked, ...props }, ref) => (
  <_CheckboxItem
    ref={ref}
    className={cn(
      "py-2 pl-8 pr-3 font-sans text-vous-text focus:bg-amber-50",
      ITEM_BASE,
      className,
    )}
    checked={checked}
...
>(({ className, inset, ...props }, ref) => (
  <_Label
    ref={ref}
    className={cn(
      "px-3 py-1.5 font-nav text-[10px] tracking-[0.15em] uppercase text-vous-text-secondary",
      inset && "pl-8",
      className,
    )}
    {...props}
