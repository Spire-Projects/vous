                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    {product.images[0] ? (
                      <button
                        ...
                        className="w-12 h-12 border border-vous-border overflow-hidden shrink-0 bg-white/90"
                      >
                        <img
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-vous-text-secondary font-sans truncate">
                        {product.categoryName}
                      </p>
                      {product.badge && (
                        <span className="inline-block mt-0.5 px-1.5 py-0.5 text-[9px] font-nav uppercase tracking-wider bg-vous-text text-vous-bg">
                          {product.badge}
                        </span>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {product.wholesalePrice && (
                        <p className="text-[11px] text-vous-text-secondary">
                          May: Bs.{" "}
                          {product.wholesalePrice.toLocaleString("es-BO")}
                        </p>
                      )}
                    </div>
                    <div>
                      ...
                      <p
                        className={`font-nav font-semibold mt-0.5 ${product.stock <= 5 ? "text-red-600" : "text-vous-text"}`}
                      >
                        {product.stock}{" "}
                        {product.stock <= 5 && (
                          <span className="text-[10px] uppercase">CRÍTICO</span>
                        )}
                      </p>
                    </div>
                      ...
                      <div className="col-span-2">
                        ...
                        <div className="flex items-center gap-1 flex-wrap mt-0.5">
                          ...
                          {product.colors.length > 5 && (
                            <span className="text-[10px] text-vous-text-secondary">
                              +{product.colors.length - 5}
                            </span>
                          )}
                        </div>
                      ...
                      <div className="col-span-2">
                        ...
                        <div className="flex items-center gap-1 flex-wrap mt-0.5">
                          {product.sizes.slice(0, 6).map((s) => (
                            <span
                              key={s}
                              className="px-1 py-0.5 text-[9px] font-nav uppercase border border-vous-border text-vous-text-secondary"
                            >
                              {s}
                            </span>
                          ))}
                  ...
                  <div className="flex items-center gap-1 flex-wrap">
                    ...
                    {product.isBestseller && (
                      <span className="text-[10px] font-nav text-green-600 uppercase">
                        Bestseller
                      </span>
                    )}
                    {product.isPreorder && (
                      <span className="text-[10px] font-nav text-blue-600 uppercase">
                        Preventa
                      </span>
                    )}
                  ...
                  {(product.colors.length > 0 || product.sizes.length > 0) && (
                    <div className="mt-2">
                      ...
                      >
                        ...
                        {expandedIds.has(product.id)
                          ? "Ocultar variantes"
                          : `Ver variantes (${(variantsMap[product.id] ?? []).length || "?"})`}
                      </button>
                      {expandedIds.has(product.id) && (
                                  ...
                                  <div className="aspect-square bg-vous-surface rounded overflow-hidden mb-1.5 relative">
                                    ...
                                    {!v.isActive && (
                                      <span className="absolute inset-0 bg-black/40 flex items-center justify-center">
                                        <span className="text-white text-[9px] font-nav uppercase tracking-wider">
                                          Inactiva
                                        </span>
                                      </span>
                                    )}
                                  ...
                                  <div className="space-y-0.5">
                                    <div className="flex items-center gap-1">
                                      {v.color && (
                                        <>
                                          <span
                                            className="w-2.5 h-2.5 rounded-full border border-vous-border shrink-0"
                                            style={{
                                              background: v.colorHex ?? "#888",
                                            }}
                                          />
                                          <span className="text-[10px] font-nav uppercase text-vous-text">
                                            {v.color}
                                          </span>
                                        </>
                                      )}
                                    ...
                                    <div className="flex items-center gap-1 pt-0.5">
                                      <span
                                        className={`text-[11px] font-nav font-semibold ${v.stock <= 0 ? "text-red-600" : v.stock <= 3 ? "text-amber-600" : "text-vous-text"}`}
                                      >
                                        {v.stock} u.
                                      </span>
                                      {v.sku && (
                                        <span className="text-[9px] text-vous-text-secondary font-mono ml-auto">
                                          {v.sku}
                                        </span>
                                      )}
                                    </div>
                  ...
                  <div className="flex items-center gap-1 flex-wrap mt-3 pt-3 border-t border-white/30">
                    <Button
                      ...
                      onClick={() => {
                        setPreview(product);
                        setPreviewImg(product.images[0] ?? null);
                      }}
                      title="Ver"
                    >
                      <Maximize2 size={13} />
                    ...
                    <Button
                      variant="ghost"
                      size="icon-sm"
                      onClick={() => setFlagsProduct(product)}
                    >
                      <Settings2 size={14} />
                    </Button>
                  </div>
                  ...
                  {filtered.map((product, idx) => (
                    <>
                      ...
                      >
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            {product.images[0] ? (
                              <button
                                ...
                                className="w-11 h-11 border border-vous-border overflow-hidden hover:opacity-80 transition-opacity bg-white/90"
                              >
                                <img
                                  src={product.images[0]}
                                  alt={product.name}
                              ...
                              <div className="w-11 h-11 border border-vous-border bg-vous-surface flex items-center justify-center">
                                <Package
                                  size={16}
                                  className="text-vous-text-secondary"
                                />
                        ...
                        <TableCell>
                          <p className="text-[13px] font-nav font-semibold text-vous-text">
                            Bs. {product.price.toLocaleString("es-BO")}
                        ...
                        <TableCell>
                          <div className="flex flex-col gap-0.5">
                            <div className="flex items-center gap-1.5">
                              ...
                              />
                              {product.stock <= 5 && (
                                <span className="text-[10px] font-nav text-red-600 uppercase">
                                  CRÍTICO
                                </span>
                              )}
                            </div>
                            {product.wholesaleOnly && (
                              <div className="flex items-center gap-1 mt-0.5">
                                <span className="text-[10px] font-nav text-vous-gold uppercase">
                                  Mayorista:
                                </span>
                                <input
                                  type="number"
                                  ...
                                  onBlur={(e) => {
                                    ...
                                    if (Number.isFinite(val) && val >= 0) {
                                      void adjustWholesaleStock(
                                        product.id,
                                        Math.floor(val),
                                      );
                                    }
                                  }}
                                  className="w-16 text-[11px] font-sans border border-vous-border bg-vous-surface px-1 py-0.5 text-vous-text"
          ...
          {preview && (
            <>
              <DialogHeader>
                ...
                <p className="text-[11px] text-vous-text-secondary font-sans">
                  {preview.slug} · {preview.categoryName}
                </p>
              </DialogHeader>
              ...
              {preview.images.length > 0 && (
                <div className="space-y-2">
                  <div className="w-full aspect-[4/3] bg-vous-surface rounded overflow-hidden">
                    <img
                      src={previewImg ?? preview.images[0]}
                      alt={preview.name}
                      className="w-full h-full object-cover"
                    />
                  </div>
                      ...
                      {preview.images.map((img, i) => (
                        <button
                          ...
                          className={`w-16 h-16 flex-shrink-0 border-2 overflow-hidden transition-colors ${
                            (previewImg ?? preview.images[0]) === img
                              ? "border-vous-gold"
                              : "border-vous-border"
                          }`}
                        >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[12px] font-sans">
                <div>
                  ...
                  <p className="text-[15px] font-nav font-semibold text-vous-text">
                    Bs. {preview.price.toLocaleString("es-BO")}
                  </p>
                  {preview.isDiscounted && preview.discountPercentage ? (
                    <p className="text-[11px] text-red-600">
                      Descuento: {preview.discountPercentage}%
                    </p>
                  ) : null}
                  {preview.wholesalePrice ? (
                    <p className="text-[11px] text-vous-text-secondary">
                      Mayorista: Bs.{" "}
                      {preview.wholesalePrice.toLocaleString("es-BO")}
                    </p>
                  ) : null}
                </div>
                <div>
                  ...
                  <p
                    className={`text-[15px] font-nav font-semibold ${preview.stock <= 5 ? "text-red-600" : "text-vous-text"}`}
                  >
                    {preview.stock} unidades
                  </p>
                </div>
                {preview.description && (
                  <div className="col-span-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {preview.colors.map((c) => (
                        <span key={c.hex} className="flex items-center gap-1">
                          <span
                            className="w-4 h-4 rounded-full border border-vous-border"
                            style={{ background: c.hex }}
                          />
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {preview.sizes.map((s) => (
                        <span
                          key={s}
                          className="px-2 py-1 text-[11px] font-nav uppercase border border-vous-border text-vous-text-secondary"
                        >
                          {s}
                        </span>
                      ))}
                        ...
                        {Object.entries(preview.attributes)
                          ...
                          .map(([k, v]) => (
                            <span key={k} className="text-[11px] font-sans">
                              <span className="text-vous-text-secondary capitalize">
                                {k}:
                              </span>{" "}
                              {v}
                            </span>
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {preview.tags.map((t) => (
                        <span
                          key={t}
                          className="px-2 py-0.5 text-[10px] bg-white/80 backdrop-blur-lg border border-white/60 rounded-3xl shadow-xl shadow-black/5 overflow-hidden font-sans text-vous-text-secondary"
                        >
                          {t}
                        </span>
                      ))}
                ...
                <div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <Badge variant={preview.isActive ? "active" : "inactive"}>
                      {preview.isActive ? "Activo" : "Inactivo"}
                    </Badge>
                    {preview.isFeatured && (
                      <span className="flex items-center gap-0.5 text-[10px] font-nav text-amber-600 uppercase">
                        <Star size={10} fill="currentColor" />
                    ...
                    {preview.badge && (
                      <span className="px-1.5 py-0.5 text-[9px] font-nav uppercase tracking-wider bg-vous-text text-vous-bg">
                        {preview.badge}
                      </span>
                    )}
                  </div>
              ...
              {previewVariants.length > 0 && (
                <div className="border-t border-white/40 pt-4">
                  <div className="flex items-center justify-between mb-3">
                    <p className="font-nav text-[10px] uppercase tracking-wider text-vous-text-secondary">
                      Variantes ({previewVariants.length})
                    </p>
                    <Button
                      variant="outline"
                      size="sm"
                      ...
                      <TableBody>
                        {previewVariants.map((v) => (
                          <TableRow key={v.id}>
                            <TableCell>
                              {v.images && v.images.length > 0 ? (
                                <div className="relative w-8 h-8 border border-vous-border rounded overflow-hidden">
                                  ...
                                  />
                                  {v.images.length > 1 && (
                                    <span className="absolute bottom-0 right-0 bg-black/60 text-white text-[7px] px-0.5 rounded-tl">
                                      +{v.images.length - 1}
                                    </span>
                                  )}
                                </div>
                              ) : (
                                <span className="text-vous-text-secondary text-[10px]">
                                  —
                                </span>
                              )}
                            </TableCell>
                            <TableCell>
                              {v.color ? (
                                <span className="inline-flex items-center gap-1.5 text-[11px] font-nav uppercase">
                                  <span
                                    className="w-3 h-3 rounded-full border border-vous-border"
                            ...
                            <TableCell className="text-[11px] font-nav uppercase">
                              {v.size ?? "—"}
                            </TableCell>
                            <TableCell>
                              <span
                                className={`text-[11px] font-nav font-semibold ${v.stock <= 0 ? "text-red-600" : v.stock <= 5 ? "text-amber-600" : "text-vous-text"}`}
                              >
                                {v.stock}
                              </span>
                            </TableCell>
