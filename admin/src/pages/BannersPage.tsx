...
import { BannerMobileList } from "@/components/banner/BannerMobileList";
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <StatCard
          label="Inactivos"
          value={String(banners.length - activeCount)}
        />
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs text-muted-foreground px-1">
        <p className="flex items-center gap-1.5 font-sans">
          ...
          <span>
            Arrastra los banners verticalmente para reordenar la secuencia del
            carrusel.
          </span>
        </p>
        <span className="font-nav text-[11px] text-muted-foreground">
