...
export function DiscountsPage() {
  const { discounts, loading, create, update, remove, toggleActive } =
    useDiscounts();
  ...
  function formatValidity(discount: Discount): string {
    const start = discount.startDate
      ? new Date(discount.startDate).toLocaleDateString("es-BO")
      : null;
    const end = discount.endDate
      ? new Date(discount.endDate).toLocaleDateString("es-BO")
      : null;
            ...
            <div className="block md:hidden divide-y divide-white/30">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      {d.description && (
                        <p className="text-[11px] text-vous-text-secondary font-sans mt-0.5">
                          {d.description}
                        </p>
                      )}
                    </div>
                  ...
                  <div>
                    ...
                    <p className="text-[11px] font-sans text-vous-text-secondary">
                      {formatValidity(d)}
                    </p>
                  </div>
              ...
              {filtered.length === 0 && (
                <div className="p-6 text-center text-vous-text-secondary text-sm font-nav">
                  {search
                    ? "No se encontraron cupones con ese filtro."
          ...
          <div className="space-y-4 pt-2">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v: DiscountScope) =>
                  setForm({ ...form, applicableTo: v })
                }
              >
                <SelectTrigger>
                  <SelectValue />
