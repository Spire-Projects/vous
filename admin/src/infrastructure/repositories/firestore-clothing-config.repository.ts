...
export const firestoreSizeRepository = {
  async findAll(): Promise<ClothingSize[]> {
    const q = query(
      collection(db, "clothing_sizes"),
      orderBy("sortOrder", "asc"),
    );
    const snap = await getDocs(q);
    return snap.docs.map((d) =>
      mapSize(d.id, d.data() as Record<string, unknown>),
    );
  },
  ...
  async update(
    ...
    await updateDoc(doc(db, "clothing_sizes", id), {
      ...data,
      updatedAt: serverTimestamp(),
    });
  },
...
export const firestoreMaterialRepository = {
  async findAll(): Promise<ClothingMaterial[]> {
    const q = query(
      collection(db, "clothing_materials"),
      orderBy("sortOrder", "asc"),
    );
    const snap = await getDocs(q);
    return snap.docs.map((d) =>
      mapMaterial(d.id, d.data() as Record<string, unknown>),
    );
  },
  ...
  async update(
    ...
    await updateDoc(doc(db, "clothing_materials", id), {
      ...data,
      updatedAt: serverTimestamp(),
    });
  },
...
export const firestoreAttributeRepository = {
  async findAll(): Promise<ClothingAttribute[]> {
    const q = query(
      collection(db, "clothing_attributes"),
      orderBy("sortOrder", "asc"),
    );
    const snap = await getDocs(q);
    return snap.docs.map((d) =>
      mapAttribute(d.id, d.data() as Record<string, unknown>),
    );
  },
  ...
  async update(
    ...
    await updateDoc(doc(db, "clothing_attributes", id), {
      ...data,
      updatedAt: serverTimestamp(),
    });
  },
...
export const firestoreBadgeRepository = {
  async findAll(): Promise<ClothingBadge[]> {
    const q = query(
      collection(db, "clothing_badges"),
      orderBy("sortOrder", "asc"),
    );
    const snap = await getDocs(q);
    return snap.docs.map((d) =>
      mapBadge(d.id, d.data() as Record<string, unknown>),
    );
  },
  ...
  async update(
    ...
    await updateDoc(doc(db, "clothing_badges", id), {
      ...data,
      updatedAt: serverTimestamp(),
    });
  },
