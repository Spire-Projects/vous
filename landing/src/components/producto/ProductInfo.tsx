  ...
  return (
    <div className="flex flex-col gap-6 max-w-md w-full">
      ...
      <p className="font-sans text-sm text-vous-gray leading-relaxed border-t border-vous-gray-light/40 pt-5">
        Una pieza esencial de nuestra colección de invierno. Diseñado con líneas precisas y una
        estructura que define la silueta contemporánea, este sobretodo fusiona la funcionalidad
        urbana con el lujo editorial.
      </p>
    </div>
  );
}
