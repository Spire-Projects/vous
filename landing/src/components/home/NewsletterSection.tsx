      ...
      <div className="max-w-[1440px] mx-auto px-5 md:px-20 flex flex-col md:flex-row justify-between items-center gap-12">
        ...
        <div className="w-full max-w-md">
          <form
            ...
            className="flex border-b border-white/50 pb-2 focus-within:border-white transition-colors"
          >
            <input
              type="email"
              value={email}
            ...
            <button
              type="submit"
              className="font-nav text-[12px] font-semibold tracking-[0.15em] text-white hover:text-white/80 transition-colors uppercase shrink-0"
            >
              UNIRSE
            </button>
          </form>
